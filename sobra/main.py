...
SELECT
PONTO.DATA,
COUNT(PONTO.COLABORADOR) QTDE,
ENTEMP.NOMERESUMIDO EMPRESA,
ENTBASE.NOMERESUMIDO BASEOPERACIONAL,
ENTCLI.NOMERESUMIDO CLIENTE,
ENTLOCAL.NOMERESUMIDO LOCALSERVICO,
ENTAREASUPERVISAO.NOMECOMPLETO AREASUPERVISAO,
TURNOTRABALHO.DESCRICAO TURNO,
ENTFUNC.NOMERESUMIDO FUNCIONARIO,
...
INNER JOIN SITMAODEOBRAFUNC
    ON (SITMAODEOBRAFUNC.FUNCIONARIO = RELFUNC.RELACAOENTIDADE
        ...
        AND (SITMAODEOBRAFUNC.DTFIM >= PONTO.DATA
...
INNER JOIN VAGAITEMCONTRATO
    ON (PONTO.VAGAITEMCONTRATO = VAGAITEMCONTRATO.VAGAITEMCONTRATO
        AND VAGAITEMCONTRATO.CLIENTE = 200
        AND VAGAITEMCONTRATO.ORIGEMVAGA = 5)
...
WHERE
PONTO.SITMOBRAHOJE = 1
AND SITMAODEOBRAFUNC.SITUACAOMOBRATEMP IN (1,2,3)
AND PONTO.SITTRABALHO = 1
AND DATA >= '21/01/2026'
GROUP BY
PONTO.DATA,
ENTEMP.NOMERESUMIDO,
